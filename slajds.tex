...
\begin{frame}{Showtime!}
    \only<1>{\includegraphics[width=\textwidth]{signup.png}}
    \only<2>{\includegraphics[width=\textwidth]{firstpost.png}}
    \only<3>{\includegraphics[width=\textwidth]{theft.png}}
    \only<4>{\includegraphics[width=\textwidth]{csrf.png}}
    \only<5>{\includegraphics[width=\textwidth]{forgeinject.png}}
    \only<6>{\includegraphics[width=\textwidth]{forgery.png}}
    \only<7>{\includegraphics[width=.4\textwidth]{fooled.png}}
\end{frame}
